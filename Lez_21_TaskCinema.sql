...
CREATE VIEW AvaibleSeatsForShow AS 
	...
	t.Capacity - COUNT(*) AS AvaibleSeats
	FROM Showtime s 
...
EXEC PurchaseTicket @TicketID=1,@ShowTimeID=3,@SeatNumber='C8',@CustomerID=3
SELECT * FROM Ticket
...
EXEC InsertNewMovie @MovieID =9,@Title='Pippo',@Director='Pippo',@ReleaseDate=NUll,@DurationMinutes=140,@Rating=5
SELECT * FROM Movie
